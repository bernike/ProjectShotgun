    ...
    <div class="contents" >
		<div class="in-contents">
		  ...
		  <a href="images/logo.png" download>Download user manual</a><br /><br />
			...
			<span id="questiontitle">Q: Are the test questions graded automatically?</span><br />
			A: Every test question is graded automatically, except for the essay.<br />
			Tests with essay questions will be submitted to the teacher to finalize the grade,<br />
			then they will be available for the student to see. <br /><br />
			<span id="questiontitle">Q: What is the difference between saving a test and publishing it?</span><br />
			A: Saving a test allows you to exit and edit it later. <br />
			Publishing a test makes it viewable for students to take within the specified time <br />
			period and disallows you from editing any further. <br /><br />
			<span id="questiontitle">Q: When I delete a test, does that make it unavailable for my students to take?</span><br />
			A: Yes, deleting a test also makes it unavailable for any students enrolled in that course. <br /><br />

			<span id="thetitle">Students: </span><br />
			<span id="questiontitle">Q: I was in the middle of taking a test, and my browser crashed. Now what?</span><br />
			A: Your test is still available to be completed, just go to your home page and click the Take Test button.<br />
			However none of your answers were saved, and the time is still counting down from when you started the test.<br /><br />
			<span id="questiontitle">Q: What happends if I click the "I cheated" button?</span><br />
			A: You will get a zero on your test. If you accidently click the button, please contact your teacher.<br /><br />
			<br /><br />
